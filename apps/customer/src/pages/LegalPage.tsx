  ...
  return <main className="legal-page shell">
    ...
    <div className="legal-layout">
      ...
      <article className="legal-document">
        ...
        <section><h2>3. Products, prices and availability</h2><p>We aim to describe and photograph products accurately, although packaging, colour and handmade characteristics may vary slightly. Cart contents do not reserve stock. Publication, stock, offers, the ₹599 minimum purchase and final totals are verified when the order is submitted. Delivery is free for serviceable addresses. If an obvious listing or pricing error is discovered, we may contact you, correct it or cancel the affected order.</p></section>
