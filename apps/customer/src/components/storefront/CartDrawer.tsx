...
import { useProductsByIds, useSiteSettings } from '../../hooks/useStoreData';
...
export function CartDrawer() {
  ...
  const { data: products = [], isSuccess: productsLoaded } = useProductsByIds(lines.map((line) => line.productId)); const { data: settings } = useSiteSettings();
